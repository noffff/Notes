...
A类地址|0(2进制)<br>7位网络号<br>24位主机号|00000000.|0*2^7 + 0*2^6 + 0*2^5 + 0*2^4 + 0*2^3 + 0*2^2 + 0*2^1 + 0*2^0  = 0|0.0.0.0~127.255.255.255|10.0.0.0~10.255.255.255<br>127.0.0.0~127.255.255.255|
B类地址|10(2进制)<br>14位网络号<br>16位主机号|10000000.|1*2^7 + 0*2^6 + 0*2^5 + 0*2^4 + 0*2^3 + 0*2^2 + 0*2^1 + 0*2^0  = 128.|128.0.0.0~191.255.255.255<br>172.16.0.0~172.31.255.255|
C类地址|110(2进制)<br>21位网络号<br>8位主机号|11000000.|1*2^7 + 1*2^6 + 0*2^5 + 0*2^4 + 0*2^3 + 0*2^2 + 0*2^1 + 0*2^0  = 192.|192.0.0.0~223.255.255.255<br>192.168.0.0~192.168.255.255|
D类地址：1110(2进制)<br>28位多播组号|11100000.|1*2^7 + 1*2^6 + 1*2^5 + 0*2^4 + 0*2^3 + 0*2^2 + 0*2^1 + 0*2^0  = 224.|224.0.0.0~255.255.255.255|255.255.255.0
## 十进制IP转化为二进制八位IP
```
207.207.207.207
